<template>
    <div class="video">
        <el-button type="btn" @click="createVideo">添加視頻</el-button>
        <el-table :data="videoList" border>
            ...
            <el-table-column label="詳情" width="100">
                <template slot-scope="scope">
                    <el-button @click="getDetail(scope.row.iframe_url)" type="text" size="small">瀏覽視頻</el-button>
                </template>
            </el-table-column>
            <el-table-column label="操作" width="200">
                <template slot-scope="scope">
                    <el-button
                        ...
                        size="small"
                    >編輯</el-button>
                    <el-button @click="deleteVideo(scope.row.id)" type="text" size="small">刪除</el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <el-dialog title="添加" :visible.sync="dialogVisible" width="30%">
            <div id="cover">
                <span class="cover_cover">上傳封面:</span>
                <el-upload
                    :action="getUploadUrl()"
